...
`verify-action-economy.mjs`, and `verify-opportunity-attacks.mjs` go one step further and
...
action-economy readout's manual marks and live mode flips, and the opportunity-attack
prompt's live landing and take/decline flow — the latter four scripts also start
