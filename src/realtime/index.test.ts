...
import { MODULE_NAME, joinCampaignChannel, joinCampaignRoomChannel, joinLobbyChannel } from "@/realtime";
...
describe("realtime module", () => {
  ...
  it("exports the campaign room channel factory from the main barrel", () => {
    expect(joinCampaignRoomChannel).toBeTypeOf("function");
  });
