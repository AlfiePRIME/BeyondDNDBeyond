...
export function GameRoom({
  ...
  }, [liveMap, cellOverlay, assetUrlById, currentUserIsDM, armedToken, visibleSelections, highlightedCellKeysForViewer, ownCharacterIds, characterById, conditionLabelsByTokenId, visionMasking, seenCells, hiddenFromViewerTokenIds]);
