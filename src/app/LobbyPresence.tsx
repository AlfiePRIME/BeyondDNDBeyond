...
export function LobbyPresence({
  ...
  // Lobby menu music playback itself now lives in GlobalMusic.tsx (mounted
  // once in the root layout, route-aware via usePathname) — it plays on
  // every route except the Game Room and the map editor, not just this one
  // page, so this component no longer manages it directly.
